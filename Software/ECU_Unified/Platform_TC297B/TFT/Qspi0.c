...
IfxQspi_SpiMaster spi0Master; /**< \brief Qspi0 global data */
...
IfxQspi_SpiMaster *qspi0_init (void)
{
    ...
    if (spi0Master.qspi == 0)
    {
        ...
        spiMasterConfig.maximumBaudrate = QSPI0_MAX_BAUDRATE;

        /* ISR priorities and interrupt target */
        spiMasterConfig.txPriority  = ISR_PRIORITY_QSPI0_TX;
        spiMasterConfig.rxPriority  = ISR_PRIORITY_QSPI0_RX;
        spiMasterConfig.erPriority  = ISR_PRIORITY_QSPI0_ER;
        spiMasterConfig.isrProvider = ISR_PROVIDER_QSPI0;
